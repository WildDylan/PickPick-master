                ...
                if (SYSTEM_VERSION_LESS_THAN(@"6")) {
                    ...
                    if ([MFMailComposeViewController canSendMail]) {
                        _actionsSheet = [[UIActionSheet alloc] initWithTitle:nil delegate:self
                                                               cancelButtonTitle:NSLocalizedString(@"返回", nil) destructiveButtonTitle:nil
                                                               otherButtonTitles:NSLocalizedString(@"保存", nil), NSLocalizedString(@"拷贝", nil), NSLocalizedString(@"邮件", nil), nil];
                    } else {
                        _actionsSheet = [[UIActionSheet alloc] initWithTitle:nil delegate:self
                                                               cancelButtonTitle:NSLocalizedString(@"返回", nil) destructiveButtonTitle:nil
                                                               otherButtonTitles:NSLocalizedString(@"保存", nil), NSLocalizedString(@"拷贝", nil), nil];
                    }
