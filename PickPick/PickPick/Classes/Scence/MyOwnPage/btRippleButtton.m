...
-(void)commonInitWithImage:(UIImage *)image andFrame:(CGRect) frame{
    ...
    _imageView.frame = CGRectMake(0, 0, frame.size.width-5, frame.size.height-5);
...
-(void)handleTap:(id)sender {
    ...
    if (isRippleOn) {
        ...
        CGRect pathFrame = CGRectMake(-CGRectGetMidX(self.bounds), -CGRectGetMidY(self.bounds) + 30, self.bounds.size.width, self.bounds.size.height);
